package com.rama.gd10_a_10735.fragment
...
import com.rama.gd10_a_10735.*
import com.rama.gd10_a_10735.databinding.FragmentDataMahasiswaBinding
    ...
    private fun getDataMahasiswa() {
        ...
        RClient.instances.getData(cari).enqueue(object :
            ...
            override fun onResponse(
                ...
                Log.d("apii", response.body().toString())
